...
if (isset($_POST['enviar'])) {
  ...
  $sql= "UPDATE destino SET des_descripcion=:descripcion WHERE des_id='".$_GET['id']."';";
  $q=$con->prepare($sql);
  $q->execute(array(':descripcion'=>$descripcion));
  header("location:http://localhost/terminal/entidades/destino/listarDestino.php");
  }
?>
...
<div class="container">
  <div class="row text-center">
    ...
    <input type="text" name="descripcion" id="descripcion" value="<?php echo $_GET['descripcion'];?>"><br>
