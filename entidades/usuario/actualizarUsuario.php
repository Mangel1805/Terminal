...
if (isset($_POST['enviar'])) {
  ...
  $sql= "UPDATE usuario SET usu_cedula=:cedula,usu_nombre=:nombre,usu_apellido=:apellido,usu_telefono=:telefono,usu_direccion=:direccion,usu_email=:email,usu_contra=:contrasena,usu_estado=:estado WHERE usu_id='".$_GET['id']."';";
  $q=$con->prepare($sql);
...
<div class="container">
  <div class="row text-center">
    ...
    <input type="text" name="contrasena"id="contrasena" value="<?php echo $_GET['contrasena'];?>"><br>
    <label>estado</label>
